...
<DatePicker  className="custom-select select-location" placeholder='778678' onChange={(date) => setDepartureDate(date)} />
                    ...
                    <div>
                        ...
                        {/* <input className='form-control' id='bus_type' type={'text'} placeholder='Enter Bus Type' value={bus_type} onChange={(e) => setbus_type(e.target.value)}> */}
                        {/* </input> */}
                    </div>
                    {/* <div>
                    ...
                    <div>
                        ...
                        <textarea className='form-control' row='3' id='description' type={'text'} placeholder='Enter Description' value={description} onChange={(e) => setDescription(e.target.value)}>
                        </textarea>
                    </div>
                    <div>
                        <label></label>
