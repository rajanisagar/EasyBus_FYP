<div className="container-fluid bus-screen-details">
           ...
           >
             ...
             <div
               className="bus-screen-details  row align-items-sm-center flex-row py-2 px-2 no-gutters color-white "
             >
               <div className="col-12 col-sm-4">
                 <div className="row mb-2  no-gutters">
                 <div className="col-sm-1 col-1 ">
                   <button className='back-icon-btn' onClick={() => navigate(-1)}><i class="fa-solid fa-angle-left back-icon"></i></button>

  
                   </div>
                   <div className="offset-1 mt-4 col-sm-3 col-3 text-center">
                     ...
                     <span
                       className="text-5 font-weight-900  d-block 01:15 AM h5 for-font text-uppercase"
                       // {bus.operator}
                       >
               ...
               <div className="col-12 col-md-3 border-left ">
                 <div className="row mt-3 mt-sm-0 no-gutters ">
                   <div className="col-sm-9 col-9 ">
                     <div className="row no-gutters">
                       <div className="col-3 text-center">
                         <p className="font-weight-600 text-3 ml-2 for-font">
                           01:15 AM
                         </p>
                         <p
                           className="font-weight-600  text-3 ml-2 pt-sm-3 pt-2 for-font"
